...
//$feedback=\DB::table('feedback')->orderBy('id' ,'DESC')->paginate(5)->get(); /*feedback table 

//connection to the database*/

$feedback = DB::table('feedback')->orderBy('id' ,'DESC')->get();

$orders=\DB::table('orders')->orderBy('id' ,'DESC')->get(); /*orders table connection to the database*/
$reservations=\DB::table('reservations')->orderBy('id' ,'DESC')->get(); /*reservation table connection to the database*/
$menu=\DB::table('specialmenus')->orderBy('id' ,'DESC')->get(); /*specialmenus table connection to the database*/
?>
					...
					<table class="table table-dark table-striped">
						...
						foreach ($reservations as $data):
							...
							<tr>
								...
								<td >
									<a type="button" class="btn btn-sm btn-success delBtn" data-toggle="modal" data-target="#delModel-{{$data->id}}">
										<i class="fa fa-trash"></i>
									</a>
									<!--<a href="{{url('/order/delete/'.$data->id)}}">Delete</a>-->
									<div class="modal fade" id="delModel-{{$data->id}}"  role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form action="{{url('/reservation/delete/ '.$data->id)}}" id="delForm" method="get" enctype="multipart/form-data">
													{{csrf_field()}}
									...
									<div class="modal fade" id="delModel-{{$data->id}}"  role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form action="{{url('/order/delete/ '.$data->id)}}" id="delForm" method="get" enctype="multipart/form-data">
													{{csrf_field()}}
													<input type="hidden" name="id">
													<div class="modal-body">
														<div class="text-danger">
									...
									<div class="modal fade" id="delModel-{{$data->id}}"  role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form action="{{url('/menu/delete/'.$data->id)}}" id="delForm" method="get" enctype="multipart/form-data">
													{{csrf_field()}}
													<input type="hidden" name="id">
													<div class="modal-body">
														<div class="text-danger">
